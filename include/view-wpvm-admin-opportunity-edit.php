...
if (!class_exists("WPVM_View_Admin_Opportunity_Edit"))
{	class WPVM_View_Admin_Opportunity_Edit extends WPVM_View
	{
		function display()
		{	
			require_once( WPVM_PLUGIN_PATH . '/include/class-wpvm-opportunity-edit-form.php' );

			$form = new WPVM_Opportunity_Edit_Form();
			...
			echo '<h2>'. $h2_intro .' Volunteering Opportunity</h2>';
