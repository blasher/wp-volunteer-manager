...
if (!class_exists('WPVM_Opportunity_List_Table'))
{	
	class WPVM_Opportunity_List_Table extends WP_List_Table
	{
...
//		      'id'                   =>__('ID'),
		      ...
		      'min_participants'     =>__('Min Participants Req'),
		      'max_participants'     =>__('Max Participants Req'),
		      'actions'              =>__('Actions')
		   );
		}
...
//			echo 'HEADERS K = ' . print_r( $this->_column_headers, true ) . "<br /><br />";
		...
		function action_links($id)
		{
			...
			// links
			$edit_link    = '/wp-admin/admin.php?page=wpvm-opportunities&action=edit&id='.(int)$id;
			$email_link   = '/wp-admin/admin.php?page=wpvm-opportunities&action=email&id='.(int)$id;
			$remove_link  = '/wp-admin/admin.php?page=wpvm-opportunities&action=delete&id='.(int)$id;

			$edit_link    = "javascript: wpvm_submit_opportunity_action_form('edit', " . (int)$id . ");";
			$email_link   = "javascript: wpvm_submit_opportunity_action_form('email', " . (int)$id . ");";
			$remove_link  = "javascript: wpvm_submit_opportunity_action_form('delete', " . (int)$id . ");";


			$out  = '';
			$out .= '<a href="' . $edit_link .'"><img src="'. $images_url .'edit.png"></a>&nbsp;&nbsp;&nbsp;';
			$out .= '<a href="' . $email_link .'"><img src="'. $images_url .'Comment.png"></a>&nbsp;&nbsp;&nbsp;';
			$out .= '<a href="' . $remove_link .'"><img src="'. $images_url .'remove.png"></a>&nbsp;&nbsp;&nbsp;';
			...
			{	foreach($records as $rec)
				{
					...
					foreach ( $columns as $column_name => $column_display_name )
					{
						...
						switch ( $column_name )
						{
							...
							case 'duration':            echo '<td '.$attributes.'>'.stripslashes($rec->duration).'</td>';   break;
							case 'min_participants':    echo '<td '.$attributes.'>'.stripslashes($rec->min_participants).'</td>';   break;
							case 'max_participants':    echo '<td '.$attributes.'>'.stripslashes($rec->max_participants).'</td>';   break;
