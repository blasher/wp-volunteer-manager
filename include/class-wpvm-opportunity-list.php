...
if (!class_exists("WPVM_OpportunityList"))
{	class WPVM_OpportunityList
	{
		...
		{	
			...
			{			
				...
				{
					$opportunity = new WPVM_Opportunity($result->id);

					foreach($fields as $field)
					{
						$opportunity->$field = $result->$field;
					}

					$this->opportunities[] = $opportunity;
				}
				$this->messages[] = WPVMUtils::pre_dump($this->opportunities);
			}
			else
