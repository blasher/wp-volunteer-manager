...
if (!class_exists("WPVM_View_Admin_Settings"))
{	class WPVM_View_Admin_Settings extends WPVM_View
	{
		function display()
		{	
			require_once( WPVM_PLUGIN_PATH . '/include/class-wpvm-settings-form.php' );

			$form = new WPVM_Settings_Form();
